    ...
    Self: Converter,
{
    ...
    fn decode_by_value(
        ...
        for &(ref value, ref result) in &match_decl.by_value {
            let value_stmt = self.value(ValueContext::new(
                &type_id.package,
                &variables,
                &value,
                None,
            ...
            let result_stmt = self.object(ObjectContext::new(
                &type_id.package,
                &variables,
                &result.object,
            ...
            elements.push(&self.match_value(
                data,
                value,
                value_stmt,
                &result.object,
    ...
    fn decode_by_type(
        ...
        for &(ref kind, ref result) in &match_decl.by_type {
            ...
            let result_value = self.object(ObjectContext::new(
                &type_id.package,
                &variables,
                &result.object,
                Some(&RpType::Name { name: type_id.name.clone() }),
